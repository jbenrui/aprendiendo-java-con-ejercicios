...
public class JabrEjercicio25Tema8 {
    public static void main(String args []){
        ...
        System.out.print("El numero "+ numeroIntroducido +" esta en la posicion "+JabrFuncionesArrays.posicionEnArray(array,numeroIntroducido));
    }
}
